...
def get_tf_dtype(value):
    """ Obtains tensorflow datatype
        ...
        * tf.bool: Boolean.
        * tf.string: String.
        :param: value Value to identify class.
    """
...
def get_single_value(value,counter=0):
    """ Recursively tracks a single element of value
        It assumes all elements as of the same kind
    """
    print('get_single_value', type(value), counter )
